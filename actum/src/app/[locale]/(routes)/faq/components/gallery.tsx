...
// const INTERVAL = 4000      // hurtigere interval
// const getSwapCount = () => Math.floor(Math.random() * 2) + 1
...
//       // skift SWAP_COUNT billeder ad gangen
...
//   return (
//       <div className="col-[content-start/4] grid grid-cols-2 gap-2 self-start">
//       {[col1, col2].map((col, colIndex) => (
//         <div key={colIndex} className="flex flex-col gap-2">
//           {col.map((url, index) => (
//             <AnimatePresence mode="popLayout" key={url}>
//       <motion.div
//   key={url}
...
//   className={`relative w-full ${getAspectRatio(colIndex * 3 + index)}`}
// >
...
{/* <div className="col-[content-start/content-end] md:col-[content-start/4] md:order-first flex flex-col md:grid md:grid-cols-2 gap-2 self-start"> */}
